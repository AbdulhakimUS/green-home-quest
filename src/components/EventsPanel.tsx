...
export const EventsPanel = () => {
  ...
  if (!gameSession?.active_events || gameSession.active_events.length === 0) return null;
      ...
      <CardContent className="p-3 sm:p-6 pt-0">
        <div className="space-y-2 sm:space-y-3">
          {gameSession.active_events.map((event: any) => {
            ...
            return (
              <div key={event.id} className="p-2.5 sm:p-3 rounded-lg border border-destructive/30 bg-card">
