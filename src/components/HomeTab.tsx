      ...
      <div className="relative aspect-[4/3] bg-gradient-to-b from-sky-200 to-success/20 rounded-2xl border-2 border-border overflow-hidden">
        ...
        <div className="absolute bottom-[25%] left-1/2 -translate-x-1/2 z-10">
          ...
          >
            ...
            <div className="absolute -top-7 sm:-top-9 left-1/2 -translate-x-1/2 flex items-center justify-center gap-1.5 sm:gap-3 bg-card/90 backdrop-blur-sm px-3 sm:px-4 py-1.5 rounded-full border sm:border-2 border-primary">
