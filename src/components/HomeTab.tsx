      ...
      <div className="relative aspect-[4/3] bg-gradient-to-b from-sky-200 to-success/20 rounded-2xl border-2 border-border overflow-hidden">
        ...
        <div className="absolute bottom-[25%] left-1/2 -translate-x-1/2 z-10">
          ...
          >
            ...
            <div className="absolute -top-9 sm:-top-11 left-1/2 -translate-x-1/2 flex items-center justify-center gap-2 sm:gap-4 bg-card/90 backdrop-blur-sm px-5 sm:px-6 py-1.5 rounded-full border sm:border-2 border-primary min-w-[210px] sm:min-w-[280px]">
